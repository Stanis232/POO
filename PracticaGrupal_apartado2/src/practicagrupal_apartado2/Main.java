...
public class Main {
    public static void main(String[] args) {
        ...
        Paciente p1 = new Paciente("Juan Pérez", "Calle A, 12", 600123123, 1111, "12345678A",h1);
        Paciente p2 = new Paciente("María Ruiz", "Avenida B, 34", 600987987, 2222, "87654321B",h2);
